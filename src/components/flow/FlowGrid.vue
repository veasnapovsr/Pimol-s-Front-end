...
<template>
  ...
  >
    <div
      ...
      :key="doc.id"
      class="bg-white border rounded-xl overflow-hidden hover:shadow-md transition"
    >
      <!-- PREVIEW -->
      <div class="relative bg-gray-100 h-64 flex items-center justify-center">
        ...
        <img
          src="/src/assets/pdf-preview.png"
          alt="preview"
      ...
      <div class="p-4 space-y-3">
        ...
        <div class="flex items-start gap-2">
          <span
            class="w-8 h-8 flex items-center justify-center rounded-lg bg-red-100 text-red-600 font-bold text-sm"
          >
            PDF
          </span>
